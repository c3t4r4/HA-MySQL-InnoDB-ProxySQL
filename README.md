...
6. Configure o ProxySQL: 
    ...
    - Configurando Monitor - (Esse monitor é o usuário criado no passo 5):
     ...
     - Configurando os Grupos de Replicação:
        ...
        | 12.10.10.229 | 3306 | 1676121199733612 | 218             | 0         | NULL  |
        | 12.10.10.209 | 3306 | 1676121199716018 | 219             | 1         | NULL  |
        +--------------+------+------------------+-----------------+-----------+-------+
        3 rows in set (0.00 sec)
        ```
...
7. Teste Funciona (Geralmente rodado em sua maquina mesmo, não no servidor ProxySQL):
